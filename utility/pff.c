...
static
FRESULT dir_rewind (
	_DIR *dj			/* Pointer to directory object */
)
{
	CLUST clst;
	FATFS *fs = FatFs;
...
static
FRESULT dir_find (
	_DIR *dj,		/* Pointer to the directory object linked to the file name */
...
static
FRESULT dir_read (
	_DIR *dj,		/* Pointer to the directory object to store read object name */
	BYTE *dir		/* 32-byte working buffer */
)
{
	FRESULT res;
...
static
FRESULT create_name (
	_DIR *dj,			/* Pointer to the directory object */
...
FRESULT follow_path (	/* FR_OK(0): successful, !=0: error code */
	_DIR *dj,			/* Directory object to return last directory and found object */
	BYTE *dir,			/* 32-byte working buffer */
