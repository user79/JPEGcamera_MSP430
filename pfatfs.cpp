...
_DIR PFFS::dir_obj;		/* Working copy of _DIR */
...
---------------------------------------------------------------------------
   Overloaded methods use working copy of FATFS, _DIR or FIL
-------------------------------------------------------------------------*/
...
FRESULT PFFS::opendir (
	_DIR *dj,			/* Pointer to directory object to create */
...
FRESULT PFFS::readdir (
	_DIR *dj,			/* Pointer to the open directory object */
